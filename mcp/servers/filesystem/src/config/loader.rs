...
impl ConfigEnvironment {
    ...
    pub fn detect() -> Self {
        match env::var("AIRSPROTOCOLS_MCPSERVER_FS_ENV")
            .or_else(|_| env::var("AIRSPROTOCOLS_MCP_FS_ENV")) // Backward compatibility
...
impl ConfigurationLoader {
    ...
    pub fn with_environment(environment: ConfigEnvironment) -> Self {
        ...
        Self {
            environment,
            config_dir,
            env_prefix: "AIRSPROTOCOLS_MCPSERVER_FS".to_string(),
        }
    }
    ...
    fn default_config_dir() -> PathBuf {
        ...
        if let Ok(config_dir) =
            env::var("AIRSPROTOCOLS_MCPSERVER_FS_CONFIG_DIR").or_else(|_| env::var("AIRSPROTOCOLS_MCP_FS_CONFIG_DIR"))
