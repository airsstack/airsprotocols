...
1. `AIRSPROTOCOLS_MCPSERVER_FS_ENV` environment variable
...
5. **Environment variables** - `AIRSPROTOCOLS_MCPSERVER_FS_*` prefixed variables
...
```bash
export AIRSPROTOCOLS_MCPSERVER_FS_SERVER__NAME="custom-mcp-fs"

# Override security settings
export AIRSPROTOCOLS_MCPSERVER_FS_SECURITY__OPERATIONS__WRITE_REQUIRES_POLICY=true

# Override filesystem paths (JSON array format)
export AIRSPROTOCOLS_MCPSERVER_FS_SECURITY__FILESYSTEM__ALLOWED_PATHS="['/app/**/*', '/data/**/*']"
```
