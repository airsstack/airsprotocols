...
```bash
export AIRSPROTOCOLS_MCPSERVER_FS_CONFIG_DIR="/path/to/your/config/directory"
```
...
```bash
AIRSPROTOCOLS_MCPSERVER_FS__SECURITY__FILESYSTEM__ALLOWED_PATHS="~/Projects/**/*"
AIRSPROTOCOLS_MCPSERVER_FS__SECURITY__OPERATIONS__WRITE_REQUIRES_POLICY="false"
```
...
**Current (recommended)**:
- `AIRSPROTOCOLS_MCPSERVER_FS_CONFIG_DIR` - Configuration directory
- `AIRSPROTOCOLS_MCPSERVER_FS_ENV` - Environment name (local, development, production)
- `AIRSPROTOCOLS_MCPSERVER_FS_LOG_DIR` - Logs directory
